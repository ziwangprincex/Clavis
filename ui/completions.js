/* Completion data for the three languages. Each entry:
   { l: trigger/label, t: snippet template ($1, $2 placeholders), d: short desc } */
...
const LATEX_COMPLETIONS = [
  ...
  // big operators
  ...['sum','prod','coprod','int','iint','iiint','iiiint','oint','bigcup','bigcap','bigvee','bigwedge','bigoplus','bigotimes']
